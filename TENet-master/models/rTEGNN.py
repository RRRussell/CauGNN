...
class Model(nn.Module):
    ...
    def __init__(self, args,data):
        ...
        # self.maxpool3 = nn.MaxPool2d(ker2nel_size=(1, args.k_size[2]), stride=1)
    ...
    def forward(self,x):
        ...
        # x_conv = self.bn2(x_conv.unsqueeze(1)).squeeze(1)
        ...
        if self.decoder == 'rGNN':
            ...
            # print(adp)
            # self.adjs1 = [self.A]
            # self.adjs = [self.adjs[0],self.adjs[1]]
            # self.adjs1 = [1./3 * (self.adjs[0]+self.adjs[1]+self.adjs[2])]
